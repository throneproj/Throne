...
namespace Configs {
    ...
    void SettingsRepo::initMaps() {
        boolMap = {
            ...
            {"xray_fragment_default_on",       &xray_fragment_default_on},
        ...
        stringMap = {
            ...
            {"xray_fragment_mode",         &xray_fragment_mode},
            {"xray_fragment_packets",      &xray_fragment_packets},
            {"xray_fragment_size",         &xray_fragment_size},
            {"xray_fragment_sleep",        &xray_fragment_sleep},
            {"xray_fragment_max_split",    &xray_fragment_max_split},
